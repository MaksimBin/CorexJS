...
🔵 README — готовый файл (скопируй всё и вставь в README.md)

Ниже — полный содержательный README: описание, реализация corex.js, пример использования и рекомендации. Скопируй весь текст начиная с # 🌌 Corex.js и вставь в README.md.

---

🔷 Описание
Corex.js — лёгкий и понятный стейт‑менеджер в духе Redux, но без лишнего. Поддерживает синхронные и асинхронные действия (thunks), middleware, провайдер для React‑подобных UI и удобный хук useStore. Идеален для небольших проектов и экспериментов.

---

🔵 Файл corex.js (полная реализация — помести в проект как corex.js)
`js
...
🔵 Пример использования (в одном файле — app-example.js)
`js
